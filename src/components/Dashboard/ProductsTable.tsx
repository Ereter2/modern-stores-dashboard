...
const ProductsTable: React.FC = () => {
  ...
  return (
    <div className="relative rounded-lg overflow-hidden animate-slide-up animation-delay-300">
      ...
      {/* Card content */}
      <div className="glass-card rounded-lg overflow-hidden relative z-10 backdrop-blur-sm shadow-lg border border-white/10">
